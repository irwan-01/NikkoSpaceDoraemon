            ...
            <div class="container">
                <table>
                    ...
                    <tbody>
                        ...
                        %>
                        <tr><td>Appointment ID</td><td><%= appointment.getAppId() %></td></tr>
                        <tr><td>Pet Name</td><td><%= (pet != null) ? pet.getPetName() : "N/A" %></td></tr>
                        <tr><td>Service Name</td><td><%= (service != null) ? service.getServiceName() : "N/A" %></td></tr>
                        <tr><td>Appointment Date</td><td><%= appointment.getAppDate() %></td></tr>
                        <tr><td>Appointment Time</td><td><%= timeFormat.format(appointment.getAppTime()) %></td></tr>
                        <tr><td>Add-On Service</td><td><%= Optional.ofNullable(appointment.getAppRemark()).orElse("None") %></td></tr>
                        <tr><td>Status</td><td><%= appointment.getStatus() %></td></tr>
                        <% } else { %>
                        <tr><td colspan="2" style="text-align: center; color: red;">Appointment details not found.</td></tr>
                        <% } %>
                    </tbody>
                </table>
            </div>
            ...
            <div class="container">
                <table>
                    ...
                    <tbody>
                        ...
                        <% } else { %>
                        <tr><td colspan="2">No result details found.</td></tr>
                        <% } %>
                    </tbody>
                </table>
            </div>
